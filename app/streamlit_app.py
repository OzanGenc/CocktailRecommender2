...
if user_input:
  ...
  try:
    ...
    try:
      ...
      st.markdown("**Given cocktail couldn't be found in the database. Also, embedding model currently is not in service, use [first version of the application](https://cocktail-recommender.herokuapp.com/).**")
